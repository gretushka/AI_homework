...
BOT_NAME = 'parsing_furniture'

SPIDER_MODULES = ['parsing_furniture.spiders']
NEWSPIDER_MODULE = 'parsing_furniture.spiders'
...
ITEM_PIPELINES = {
   'parsing_furniture.pipelines.HardwareStoreParserPipeline': 400,
   'parsing_furniture.pipelines.PhotosPipeline': 200
}
